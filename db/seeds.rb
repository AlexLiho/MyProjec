...
products_list = [
    #[id, name]
    [1, 'Уборка однокомнатной квартиры', false, 1500, 'ед.', nil, 'Уборка квартиры с 1 жилой комнатой и одной ванной.'],
    [2, 'Уборка двухкомнатной квартиры', false, 1800, 'ед.', nil, 'Уборка квартиры с 2 жилыми комнатами и одной ванной.'],
    [3, 'Уборка трехкомнатной квартиры', false, 2000, 'ед.', nil, 'Уборка квартиры с 3 жилыми комнатами и одной ванной'],
    [4, 'Уборка четырехкомнатной квартиры', false, 2900, 'ед.', nil, 'Уборка квартиры с 4 жилыми комнатами и одной ванной'],
